...
import SidebarMenuMobil from "../../components/modal/SidebarMenuMobil.jsx";
                ...
                <div className={"main-container"}>
                    <form className={"form__add"}>
                        <label className={"custum-file-upload"}>
                            ...
                            <div className={"text"}>
                                <span>Нажмите, чтобы добавить видео</span>
                            </div>
                            <input type="file" id="file"/>
                        </label>
                        <input placeholder={"Придумайте нзавание"} className={"Name"}/>
