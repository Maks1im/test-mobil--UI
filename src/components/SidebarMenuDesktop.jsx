        ...
        <nav className="navbar">
            <ul className={"menu-list-wrapper"}>
                <div className={"menu-items-wrapper"}>
                    ...
                    <li className="menu-item"><NavLink className={"links"} to={"/home"}>
                ...
                <div className={"other__menu"}>
                    ...
                    <li className="menu-item"><a className={"links"} href={"https://t.me/Maxsc11"}>
                        <svg xmlns="http://www.w3.org/2000/svg" width="30" fill="currentColor" className="bi bi-question-circle" viewBox="0 0 16 16">
